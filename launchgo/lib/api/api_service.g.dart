...
class _ApiService implements ApiService {
  ...
  @override
  Future<HttpResponse<void>> deleteFCMToken(String token) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  @override
  Future<HttpResponse<dynamic>> getSemesters() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  Future<HttpResponse<dynamic>> getDocuments(
    ...
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'semesterId': semesterId};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<HttpResponse<dynamic>>(Options(
      method: 'GET',
  ...
  @override
  Future<HttpResponse<dynamic>> getSchedule(String userId) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  @override
  Future<HttpResponse<dynamic>> getAssignments(String userId) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  Future<HttpResponse<dynamic>> createAssignment(
    ...
    final _options = _setStreamType<HttpResponse<dynamic>>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          '/users/${userId}/courses/${courseId}/assignments',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
  ...
  Future<HttpResponse<dynamic>> updateAssignment(
    ...
    final _options = _setStreamType<HttpResponse<dynamic>>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          '/users/${userId}/courses/${courseId}/assignments/${assignmentId}',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
  ...
  Future<HttpResponse<dynamic>> uploadAttachment(
    ...
    final _options = _setStreamType<HttpResponse<dynamic>>(Options(
      ...
      contentType: 'multipart/form-data',
        ...
        .compose(
          _dio.options,
          '/users/${userId}/courses/${courseId}/assignments/${assignmentId}/attachments',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
  ...
  Future<HttpResponse<void>> deleteAttachment(
    ...
    final _options = _setStreamType<HttpResponse<void>>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          '/users/${userId}/courses/${courseId}/assignments/${assignmentId}/attachments/${attachmentId}',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
  ...
  Future<HttpResponse<dynamic>> updateEvent(
    ...
    final _options = _setStreamType<HttpResponse<dynamic>>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          '/users/${userId}/events/${eventId}/single',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
  ...
  Future<HttpResponse<dynamic>> updateRecurringEvent(
    ...
    final _options = _setStreamType<HttpResponse<dynamic>>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          '/users/${userId}/events/${eventId}/recurrence',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
  ...
  Future<HttpResponse<dynamic>> checkInEvent(
    ...
    final _options = _setStreamType<HttpResponse<dynamic>>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          '/users/${userId}/events/${eventId}/location/check-in',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
  ...
  @override
  Future<HttpResponse<dynamic>> getUserPermissions(String userId) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
